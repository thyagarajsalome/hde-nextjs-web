...
const CARD_COLUMNS = 'id,title,slug,image_url,alt_text,layout_shape,dimensions,cabinet_finish,countertop_material,formatted_budget,is_featured,is_active,display_order';
