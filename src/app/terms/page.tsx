...
export const metadata: Metadata = {
  ...
  description: 'Read the Terms of Service for using Home Design English calculators, architectural floor plans, cost estimation tools, and property guidance services.',
  alternates: {
    canonical: '/terms',
  },
};
...
export default function TermsPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-16 min-h-[60vh] prose prose-indigo dark:prose-invert">
      ...
      <h2>2. Use of Service &amp; Regional Calculators</h2>
      ...
      <h2>3. Dubai Real Estate Referral &amp; Inquiries</h2>
