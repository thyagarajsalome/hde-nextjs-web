  ...
  return (
    <html lang="en" data-scroll-behavior="smooth">
      <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" media="print" onLoad={(e) => { (e.target as HTMLLinkElement).media = "all"; }} />
        <noscript>
