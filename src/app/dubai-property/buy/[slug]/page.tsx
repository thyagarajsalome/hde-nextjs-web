...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      images: [{ url: `${BASE_URL}/images/hero/hero-uae.webp`, width: 1200, height: 630, alt: `${currentType.label} in ${currentArea.name}` }],
    },
    twitter: {
      card: 'summary_large_image',
      title,
      description,
      images: [`${BASE_URL}/images/hero/hero-uae.webp`],
    },
  };
}
