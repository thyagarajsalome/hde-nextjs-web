...
const CITIES = [
  { name: 'Los Angeles', slug: 'los-angeles-california', region: 'Southern California' },
  { name: 'San Diego', slug: 'san-diego-california', region: 'Southern California' },
  { name: 'San Francisco', slug: 'san-francisco-california', region: 'Bay Area' },
];
        ...
        <section className="bg-slate-900 border-b border-slate-800 text-white py-10 px-4 sm:px-6">
          <div className="max-w-6xl mx-auto space-y-4">
            <nav className="flex items-center gap-2 text-xs text-slate-400">
              ...
              <span>/</span>
              <span className="text-amber-400 font-semibold">California</span>
            </nav>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-slate-300 text-xs sm:text-sm mt-1.5 max-w-2xl leading-relaxed">
                  Evaluate Proposition 13 property taxes, mortgage affordability, and home remodeling investments in California.
                </p>
              </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-base sm:text-lg font-black text-slate-900 dark:text-zinc-100 flex items-center gap-2">
                ...
                California City Directory &amp; Tools
              </h2>
                  ...
                  <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100 dark:border-zinc-800">
                    <div className="flex items-center gap-2.5">
                      ...
                      <h3 className="text-base font-extrabold text-slate-900 dark:text-zinc-100 flex items-center gap-2">
                        <span>{city.name}, California</span>
